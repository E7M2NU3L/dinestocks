    ...
    <div className="lg:grid lg:min-h-[90vh] lg:grid-cols-12">
        ...
        <div className="max-w-xl lg:max-w-3xl">
            ...
            <h1 className="mt-6 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl">
                Welcome To Dinestocks
            </h1>

            <p className="mt-4 leading-relaxed text-gray-500">
            create your sinestocks account as either restaurant or vendor to experience the unique B2B connectivity within perfect vendors on your nearby area
            </p>

           <Tabs radius='none' className='mt-12'>
            <Tab title={"register as Restaurant"}>
            ...
            <Tab title={"Register as a Vendor"}>
            <form action="#" className="mt-8 grid grid-cols-6 gap-6">
            <div className="col-span-6 sm:col-span-3">
                <label htmlFor="FirstName" className="block text-sm font-medium text-gray-700">
                First Name
            ...
            <Tab title={"Register as a worker"}>
            <form action="#" className="mt-8 grid grid-cols-6 gap-6">
            <div className="col-span-6 sm:col-span-3">
                <label htmlFor="FirstName" className="block text-sm font-medium text-gray-700">
                First Name
